...
export const AgentFrom = ({ onSuccess, onCancel, initialValues }: AgentFromProps) => {
    const trpc = useTRPC()
                ...
                <FormField name="instructions" control={form.control}
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="You are a helpful assistant that can answer questions and help with tasks" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
