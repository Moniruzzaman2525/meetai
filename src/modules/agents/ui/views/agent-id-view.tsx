...
import { UpdateAgentsDialogue } from "../components/update-agents-dialogue";
...
export const AgentIdView = ({ agentId }: Props) => {
    ...
    return (
        <>
            <RemoveConfirmation />
            <UpdateAgentsDialogue open={updateAgentDialogueOpen} onOpenChange={setUpdateAgentDialogueOpen} initialValues={data} />
            <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-4">
                <AgentIdViewHeader agentId={agentId} agentName={data.name} onEdit={() => setUpdateAgentDialogueOpen(true)} onRemove={handleRemoveAgent} />
