...
export const CommandSelect = ({
    ...
    return (
        <>
            <Button onClick={() => setOpen(true)} className={cn('h-9 justify-between font-normal px-2', !selectedOption && 'text-muted-foreground', className)} variant="outline" type="button">
                <div>
